                ...
                <div class="md:flex items-center gap-10 hidden">
                    <ul data-aos="fade-left" class="md:flex hidden items-center text-zinc-300 gap-10">
                        ...
                        <li class="relative group"><a
                                ...
                                <div id="dropdownMenu"
                                    class="absolute hidden w-52 fadeIn group-hover:flex top-5 pt-3 left-0 bg-[#080909] z-30 flex-col">
                                    <a href="/#.html"
                    ...
                    <div id="content-1" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                        <div class="pb-5">
                            <ul class="space-y-6 pl-3 pt-6 text-gray-400">
                                <li><a class="text-nowrap" href="/online-shopping-cashback.html">Grandmaster</a></li>
                                <li><a class="text-nowrap" href="/offline-shopping-cashback.html">Ainuko</a></li>
                                <li><a class="text-nowrap" href="/reise-cashback.html">MardAgamra</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
