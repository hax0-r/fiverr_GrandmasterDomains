        ...
        <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto">
                <a data-aos="zoom-in" href="/index.html" class="flex justify-center ">
                    <img src="/docs/assets/images/logo.png" class="md:h-24 h-16" alt="">
                </a>
                <ul data-aos="fade-up"
                    class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 pt-12 ">
                    <li><a href="index.html" class="text-gray-100 hover:opacity-80 transition-all duration-500">Home</a>
                    </li>
                ...
                <div data-aos="fade-up" class="flex items-center justify-center text-zinc-200 text-2xl gap-8 mt-7">
                    <a href="">
                ...
                <div
                    class="border-t md:flex-row flex-col gap-5 border-gray-400 pt-5 flex items-center justify-center mt-8">
                    <span class="text-lg text-gray-100 text-center block">© <span id="copyright"></span>
                        GrandmasterDomains. All
                        rights reserved.
                    </span>
                </div>
            </div>
